...
public class BinaryConstraint < D > 
{
     ...
     */
    public static < D > List < BinaryConstraint < D >> alldiff(Variable < D > ...vars) //means 0 or more parameters
    {
    ...
    public Variable < D > depends(Variable < D > var) 
    {
        ...
        System.out.println("var " +
            var.getName() + "does not depends on " + x.getName() + " nor " + y.getName());
        return null;
    }
